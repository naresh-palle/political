...
import { ArrowRight, ShieldCheck, MapPin, Radio, Users2, Globe2, Sparkles } from "lucide-react";
      ...
      <header className="relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6 text-[13px] text-[#D8CFB8]">
            ...
            <a href="#methodology" className="hover:text-[#F5EFE0] transition-colors">Methodology</a>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 lg:py-20 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center w-full animate-rise">
          <div className="lg:col-span-7 space-y-7">
            ...
            <p className="text-[16px] text-[#D8CFB8] max-w-xl leading-relaxed">
              ...
              social listening, calibrated to the role of every user.
            </p>
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="grid grid-cols-2 gap-4">
              <StatCard label="Constituencies" value="248" note="AC coverage across 4 states" />
              <StatCard label="Signals / day" value="31,310" note="Social + civic mentions" gold />
              <StatCard label="Verified profiles" value="1,024" note="Candidate handles" />
              <StatCard label="Grievances" value="8,942" note="Resolved this month" gold />
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            <ModuleCard
              ...
              body="Candidate footprint, competitive position and digital reach for any AC — synthesised in under a minute."
              accent="#B45309"
            />
            <ModuleCard
              num="02"
              ...
              title="Grievance CRM"
              body="Citizen applications routed by ward, department and SLA — from WhatsApp intake to closure."
              accent="#0F766E"
            />
            <ModuleCard
              num="03"
              ...
              body="Squad-level operations, WhatsApp dispatch, canvassing and amplification efficiency."
              accent="#D4A24C"
            />
            <ModuleCard
              num="04"
              ...
              title="Web Studio"
              body="Publish candidate landing pages with manifesto, events and grievance intake in minutes."
              accent="#0B1A2C"
            />
            <ModuleCard
              num="05"
              ...
              title="Team & RBAC"
              body="Role-based access from Executive Briefing to Field Only — every metric respects clearance."
              accent="#B0203C"
            />
            <div className="rounded-xl border border-dashed border-[#D5D3C8] bg-[#F5F4EE] p-5 flex flex-col justify-between">
              <div>
                <div className="eyebrow text-[#8A8E9B]">Coming soon</div>
                <div className="font-display text-[24px] text-[#0B1A2C] mt-2 leading-tight">
                  Presentation <span className="italic">boardroom</span>
                </div>
                <p className="text-[13px] text-[#5A5E6B] mt-2 leading-relaxed">
                  Full-screen dark boardroom view a director can flip to during briefings.
                </p>
              </div>
              <button
                onClick={onEnter}
                className="mt-4 text-[12px] font-semibold text-[#0B1A2C] hover:text-[#B45309] inline-flex items-center gap-1"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-8 items-start">
          <div className="md:col-span-2 space-y-3">
            ...
            <h3 className="font-display text-[30px] leading-tight tracking-[-0.01em] text-[#0B1A2C]">
              ...
              <span className="italic" style={{ color: "#0F766E" }}>provenance</span> label.
            </h3>
...
const StatCard: React.FC<{ label: string; value: string; note?: string; gold?: boolean }> = ({ label, value, note, gold }) => (
  <div className="rounded-xl border border-[#D4A24C]/25 bg-[#0F2338]/70 px-5 py-4">
    <div className="eyebrow text-[#B9AF95]">{label}</div>
    <div className={`font-display text-[38px] leading-none mt-2 ${gold ? "gold-text" : "cream-text"}`}>
      {value}
    </div>
